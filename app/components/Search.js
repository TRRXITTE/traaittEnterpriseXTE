...
export default class Search extends Component<Props, States> {
  ...
  openSearchInExplorer = () => {
    ...
    remote.shell.openExternal(
      `https://explorer.traaitt.com/?hash=${encodeURIComponent(query)}#blockchain_transaction`
    );
  };
  ...
  openInExplorer = (event: any) => {
    ...
    remote.shell.openExternal(
      `https://explorer.traaitt.com/?hash=${encodeURIComponent(hash)}#blockchain_transaction`
    );
  };
                                ...
                                <tbody>
                                  <tr className="no-hover">
                                    ...
                                    <td>
                                      ...
                                      <br />
                                      {session.atomicToHuman(fee, true)} XTE
                                      <br />
                                      <p
                                        className={
                                          amount < 0
