...
Array.prototype.toVectorString = function () {
  const arr = new TurtleCoinCrypto.VectorString()
    ...
    describe('N/N', () => {
      ...
      describe('Party 1', () => {
        it('Generate Shared Public Spend Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPublicKey([party1.spend.publicKey, party2.spend.publicKey].toVectorString())

          assert(sharedKey === sharedKeys.spend.publicKey)
        })

        it('Generate Shared Private View Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPrivateKey([party1.view.secretKey, party2.view.secretKey].toVectorString())
      ...
      describe('Party 2', () => {
        it('Generate Shared Public Spend Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPublicKey([party2.spend.publicKey, party1.spend.publicKey].toVectorString())

          assert(sharedKey === sharedKeys.spend.publicKey)
        })

        it('Generate Shared Private View Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPrivateKey([party2.view.secretKey, party1.view.secretKey].toVectorString())
      ...
      describe('Transactions', () => {
        it('Restore KeyImage from Partial KeyImages', () => {
          ...
          const keyImage = TurtleCoinCrypto.restoreKeyImage(tx.publicEphemeral, tx.derivation, tx.input.index, [keyImage1, keyImage2].toVectorString())
        ...
        it('Restore Ring Signatures from Partial Signing Keys', () => {
          ...
          const sig1 = TurtleCoinCrypto.generatePartialSigningKey(prep.signatures.get(3), party1.spend.secretKey)

          const sig2 = TurtleCoinCrypto.generatePartialSigningKey(prep.signatures.get(3), party2.spend.secretKey)

          const sigs = TurtleCoinCrypto.restoreRingSignatures(tx.derivation, tx.input.index, [sig1, sig2].toVectorString(), 3, prep.key, prep.signatures)
    ...
    describe('N1/N', () => {
      ...
      describe('Party 1', () => {
        it('Generate Multisig Keys', () => {
          const keys = TurtleCoinCrypto.calculateMultisigPrivateKeys(party1.spend.secretKey, [party2.spend.publicKey, party3.spend.publicKey].toVectorString())
        ...
        it('Generate Shared Public Spend Key', () => {
          ...
          const sharedKey = TurtleCoinCrypto.calculateSharedPublicKey(keys.toVectorString())

          assert(sharedKey === sharedKeys.spend.publicKey)
        })

        it('Generate Shared Private View Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPrivateKey([party1.view.secretKey, party2.view.secretKey, party3.view.secretKey].toVectorString())
      ...
      describe('Party 2', () => {
        it('Generate Multisig Keys', () => {
          const keys = TurtleCoinCrypto.calculateMultisigPrivateKeys(party2.spend.secretKey, [party3.spend.publicKey, party1.spend.publicKey].toVectorString())
        ...
        it('Generate Shared Private View Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPrivateKey([party2.view.secretKey, party3.view.secretKey, party1.view.secretKey].toVectorString())
      ...
      describe('Party 3', () => {
        it('Generate Multisig Keys', () => {
          const keys = TurtleCoinCrypto.calculateMultisigPrivateKeys(party3.spend.secretKey, [party1.spend.publicKey, party2.spend.publicKey].toVectorString())
        ...
        it('Generate Shared Private View Key', () => {
          const sharedKey = TurtleCoinCrypto.calculateSharedPrivateKey([party3.view.secretKey, party2.view.secretKey, party1.view.secretKey].toVectorString())
      ...
      describe('Transactions', () => {
        it('Restore KeyImage from Partial KeyImages of Party #1 & Party #2', () => {
          ...
          const keyImage = TurtleCoinCrypto.restoreKeyImage(tx.publicEphemeral, tx.derivation, tx.input.index, partialKeyImages.toVectorString())
        ...
        it('Restore Ring Signatures from Partial Signing Keys of Party #1 & Party #2', () => {
          ...
          party1.multisig.secretKeys.forEach(key => {
            const keyImage = TurtleCoinCrypto.generatePartialSigningKey(prep.signatures.get(3), key)
          ...
          const sigs = TurtleCoinCrypto.restoreRingSignatures(tx.derivation, tx.input.index, partialSignatures.toVectorString(), 3, prep.key, prep.signatures)
