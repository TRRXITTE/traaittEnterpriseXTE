...
function verifyAndSendTransaction(tx, fee, paymentID, inputs, changeAddress, changeRequired, subWallets, daemon, config) {
    return __awaiter(this, void 0, void 0, function* () {
        Logger_1.logger.log(`Created transaction: ${JSON.stringify(tx.transaction)}`, Logger_1.LogLevel.TRACE, Logger_1.LogCategory.TRANSACTIONS);
        ...
        try {
            ...
            if (err.statusCode === 504) {
                return [undefined, undefined, new WalletError_1.WalletError(WalletError_1.WalletErrorCode.DAEMON_STILL_PROCESSING)];
            }
        ...
        if (!relaySuccess) {
            ...
            return [undefined, undefined, new WalletError_1.WalletError(WalletError_1.WalletErrorCode.DAEMON_ERROR, customMessage)];
        }
