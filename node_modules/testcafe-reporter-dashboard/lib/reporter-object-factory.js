...
function reporterObjectFactory(readFile, fetch, settings, logger, tcVersion) {
    ...
    function processDashboardWarnings(dashboardInfo) {
        if (dashboardInfo.type === types_1.DashboardValidationResult.warning) {
    ...
    const reporterPluginObject = {
        ...
        async init() {
            ...
            if (!validationResponse.ok) {
                const errorMessage = responseJson.message ? responseJson.message : texts_1.AUTHENTICATION_TOKEN_REJECTED;
