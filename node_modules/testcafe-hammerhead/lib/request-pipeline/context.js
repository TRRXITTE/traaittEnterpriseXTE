...
class RequestPipelineContext {
    constructor(req, res, serverInfo) {
        ...
        this.requestId = (0, generate_unique_id_1.default)();
        ...
        if (req.headers.cookie) {
            const parsedClientSyncCookieStr = (0, cookie_1.parseClientSyncCookieStr)(req.headers.cookie);
    ...
    async mockResponse() {
        ...
        this.destRes = await (0, get_response_1.default)(this.mock);
